...
> **PENDING.** Figures have not yet been regenerated. Run `scripts/plot_results.py` pointed at `results/experiment_1_llama_shuffled.csv` and `results/experiment_1_qwen_shuffled.csv`.
